...
with open("D:/Phyai/frontend/app/simulate/page.tsx", "w", encoding="utf-8") as f:
    f.write(simulate_tsx)
print("Written: simulate/page.tsx")

# Also update .env.local to use env variable properly
env_local = "NEXT_PUBLIC_API_URL=http://localhost:8000\n"
with open("D:/Phyai/frontend/.env.local", "w") as f:
    f.write(env_local)
print("Written: .env.local")

print("\nAll frontend v2 files written.")
